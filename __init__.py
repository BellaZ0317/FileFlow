...
def page_not_found(error): # will send me an email with hopefully some relevant information using sendgrid
	...
	message.add_to('Bella Zhong <abigailzhong219@gmail.com>')
	message.set_subject('500 Error on FileFlow')
	message.set_html('')
	message.set_text('Hey dave, there was another error on fileflow I apologize! FileFlow currently has visitors, so get on dat.')
	message.set_from('Space Admin <Admin@fileflow.bella.me>')
